...
def create_view_gui(cell_row):  # creates the pop-up for the details of the song
    ...
    song_name_info = ctk.CTkLabel(frame, text = lucene_score, bg_color = "#333333")
...
def settings_tab_gui():  # creates the settings tab
    ...
    top_k_frame.grid(row = 1, column = 2, sticky = "nsew", padx = 5, pady = 5)
...
def del_song_func_2(artist, song):
    ...
    artist_docs, artist_scores = luc_engine.search_index("lyrics", "artist", artist, True, 300)
    song_name_docs, song_name_scores = luc_engine.search_index("lyrics", "song_name", song, True, 50)
